...
import com.cc.doctormhealth.leanchat.event.ConversationMemberClickEvent;
...
import com.cc.doctormhealth.leanchat.viewholder.ConversationDetailItemHolder;
...
public class ConversationDetailActivity extends AVBaseActivity {
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    if (menuId == ADD_MEMBERS) {
      Intent intent = new Intent(this, com.cc.doctormhealth.leanchat.activity.ConversationAddMembersActivity.class);
  ...
  private void gotoModifyNameActivity() {
    Intent intent = new Intent(this, com.cc.doctormhealth.leanchat.activity.UpdateContentActivity.class);
